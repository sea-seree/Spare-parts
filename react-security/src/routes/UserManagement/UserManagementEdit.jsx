...
import { addUser, editUser, getUserById, getUsers } from '../../api/UserApi';
                    ...
                    <div className="container-fluid-1">
                        <div className="row justify-content-center">
                            <div className="col-md-8">
                                ...
                                <Form className="col-md-10" method="post" action={`/UserManagement/${user.id}/Edit`}>
                                    ...
                                    <select id="role" name="role" defaultValue={user.role}>
                                        ...
                                        {/* <input type='text' id="role" name='role' defaultValue={user.role}
                                         (user.role === 1) ? "Admin" : ((user.role === 2) ? "Supervisor" : "Technical Maintainence" )  /> */}
